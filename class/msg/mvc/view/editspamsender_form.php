...
/** Edit Spam Sender Form */
class EditSpamSenderForm extends CForm
{
	...
	protected function init_contents(array $args)
	{
		...
		$attrs = array('style'=>'border:1px solid black;padding:3px;margin:0px 5px 0px 3px;');
		$ctrls[] = new CHtmlElement('div', $attrs, $value);
